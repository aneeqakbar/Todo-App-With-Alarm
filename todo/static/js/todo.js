...
window.onload = () => {
    document.getElementById("datefield").setAttribute("min", today + 'T00:00');

    let todo_checkboxes = document.querySelectorAll(".todo-checked");
    ...
    todo_checkboxes.forEach(checkbox => {
